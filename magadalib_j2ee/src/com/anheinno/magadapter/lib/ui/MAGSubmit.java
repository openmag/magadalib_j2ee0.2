...
public class MAGSubmit extends MAGInputBase {
	...
	public MAGSubmit(String title, String action, String url) {
		this(title, action, url, MAGLinkableComponent.MAGLinkTarget.LINK_TARGET_SELF, null);
	}

	public MAGSubmit(String title, String action, String url, MAGLinkableComponent.MAGLinkTarget target) {
		this(title, action, url, target, null);
	}

	public MAGSubmit(String title, String action, String url, MAGLinkableComponent.MAGLinkTarget target, String id) {
		super(title, id, "");
